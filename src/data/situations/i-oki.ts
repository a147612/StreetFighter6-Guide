...
export const GROUP_I: Situation[] = [
  {
    ...
    distance: 'pointBlank',
    stance: 'theyAreDown',
    opponentOptions: ['do-nothing', 'delayed-tech', 'drive-parry', 'mash-light', 'reversal', 'backdash', 'teleport', 'jump-neutral', 'drive-reversal'],
    evaluations: [
      {
        optionId: 'meaty',
        risk: 'medium',
      ...
      },
      {
        ...
        versus: [
          ...
          { vs: 'drive-parry', outcome: 'bigWin' },
          {
            ...
            outcome: 'loss',
            note: {
              'zh-Hant': '每一隻角色都有 4 幀的小技，比 5 幀的指令投先打到 —— 這是對付指令投最便宜的答案。',
              en: 'Every character has a 4-frame light and it hits before a 5-frame command grab. That is the cheapest answer to one there is.',
              ja: '全キャラが4Fの弱攻撃を持ち、5Fのコマンド投げより先に当たる。コマンド投げへの最も安い対策。',
            },
          },
          { vs: 'reversal', outcome: 'bigLoss' },
          {
          ...
          },
          {
            ...
            note: {
              'zh-Hant':
                '瞬移躲得掉指令投，而且不用猜時機。指令投角色的起攻對這四隻要多算一層。',
              en: 'A teleport escapes a command grab without having to guess the timing right. Against these four, a grappler\'s oki has one more layer to solve.',
              ja: 'テレポートはタイミングを読まずともコマ投げから逃げられる。この4キャラ相手では、コマ投げキャラの起き攻めに一段階余分な読みが必要になる。',
            },
          },
        ],
        notes: {
