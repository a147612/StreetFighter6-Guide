...
export const GROUP_A: Situation[] = [
  {
    ...
    brief: {
      'zh-Hant':
        '倒地後可以馬上起來，也可以晚一點起來。對手的壓持續是照哪一個算的，決定他打不打得中。',
      en: 'You can get up immediately or stay down a moment. Which one their meaty was timed for decides whether it hits.',
      ja: 'すぐ起きるか、少し遅らせて起きるか。相手の重ねがどちらに合わせてあるかで、当たるかどうかが決まる。',
    },
    summary: {
      'zh-Hant':
        '大部分倒地都能選：按受身馬上起來，或不按讓角色晚一點起來。強制倒地（掃腿、多數摔投）沒得選，時間是固定的。\n兩個選項本身沒有好壞，重點只有一個 —— 對手的壓持續是照哪一個算時間的。一直用同一個，就會被算得剛剛好的壓持續一直打中。',
      en: 'Most knockdowns let you choose: press to rise at once, or stay down and get up later. Hard knockdowns (sweeps, most throws) give no choice — the timing is fixed.\nNeither choice is better on its own. All that matters is which one their meaty was timed for. Always picking the same one means eating a perfectly timed meaty all match.',
      ja: 'ほとんどのダウンでは、受身ですぐ起きるか、受身せず遅く起きるかを選べる。ハードダウン（足払いや多くの投げ）では選べず、タイミングは固定される。\nどちらが優れているわけでもない。重要なのは相手の重ねがどちらに合わせてあるかだけ。片方に偏れば、完璧なタイミングの重ねを一試合中もらい続ける。',
    },
    position: ['midscreen', 'nearCorner', 'cornered'],
    opponentOptions: ['meaty', 'delayed-attack', 'walk-fake-throw', 'reset-neutral'],
    evaluations: [
      {
        optionId: 'quick-rise',
        risk: 'medium',
        ...
        onSuccess: {
          text: {
            'zh-Hant': '你比對手預期的早起來，他的壓持續時間點會落在你已經能防禦之後 —— 攻勢等於空轉一次。',
        ...
        onFail: {
          text: {
            'zh-Hant': '對手就是算著快起的時間點在壓持續 —— 你起來的那一格正好吃到打擊或摔投，而且是最佳時機的版本。',
        ...
        versus: [
          ...
          { vs: 'walk-fake-throw', outcome: 'even' },
          { vs: 'reset-neutral', outcome: 'win' },
        ],
        mixRatio: '50-70%',
        verified: 'estimated',
        notes: {
      ...
      },
      {
        ...
        onFail: {
          text: {
            'zh-Hant': '對手沒有急著壓持續，而是走過來重新站好 —— 你多躺的那段時間全部變成他佈置的時間，狀況比快起更差。',
        ...
        versus: [
          ...
          { vs: 'walk-fake-throw', outcome: 'loss' },
          { vs: 'reset-neutral', outcome: 'even' },
        ],
        mixRatio: '30-50%',
        verified: 'estimated',
        notes: {
...

  {
    ...
    brief: {
      'zh-Hant':
        '你倒在場地中間，對手站在你身上等你起來。身後還有空間，所以後衝刺和跳躍還算數。',
      en: 'You are down mid-stage with them standing over you. There is space behind you, so backdash and jumps still count.',
      ja: '画面中央でダウンし、相手が密着して起き上がりを待っている。後方に空間があるため、バックダッシュやジャンプがまだ機能する。',
    },
    summary: {
      'zh-Hant':
        '身後有半個場地，這讓後衝刺和前跳從「不能用」變成「可以混」。\n失敗也比角落便宜：被打中不會直接進角落，而且對手在場中的連段傷害本來就比較低。',
      en: 'Half a stage sits behind you, which turns backdash and forward jump from unusable into real parts of the mix.\nBeing wrong is cheaper here too: a hit does not put you straight into the corner, and their midscreen combos do less anyway.',
      ja: '後方に画面半分の空間があるため、バックダッシュや前ジャンプが「使えない」から「混ぜられる」に変わる。\n読み負けの代償も軽い。被弾しても即画面端ではなく、中央のコンボは火力自体も低い。',
    },
    position: ['midscreen'],
    ...
    evaluations: [
      {
        ...
        onSuccess: {
          text: {
            'zh-Hant': '晚一點按，疊上來的打擊先打到你的防禦，摔投還來得及解。一次覆蓋兩個最常見的起攻選擇。',
        ...
        onFail: {
          text: {
            'zh-Hant': '對手也把打擊延遲了，正好打在你按解投的瞬間 —— counter hit，傷害與連段長度都上一階。',
      ...
      },
      {
        ...
        onFail: {
          text: {
            'zh-Hant': '對手沒有摔投，而是後退看著你按 —— 解投的動作有硬直，你會吃到一套完整的懲罰。',
      ...
      },
      {
        ...
        onSuccess: {
          text: {
            'zh-Hant': '吸收打擊並回一些 Drive。時機夠準會變成完美撥擋，對手大幅硬直，你能直接反打一套。',
        ...
        onFail: {
          text: {
            'zh-Hant': '撥擋防不住摔投。傷害不高，但你花掉的 Drive 拿不回來，而且起攻循環繼續。',
      ...
      },
      {
        ...
        onSuccess: {
          text: {
            'zh-Hant': '躲開摔投與大部分近身打擊，並且真的拉開了距離 —— 場中才有的收益，回到中距離重新開始。',
        ...
        onFail: {
          text: {
            'zh-Hant': '後衝刺沒有無敵，收招也長。對手壓持續或延遲打擊都會抓到你落地的那段 —— 通常是 counter hit。',
      ...
      },
      {
        ...
        onSuccess: {
          text: {
            'zh-Hant': '跳過對手換到他背後，摔投與下段全部落空。場地位置重置，你也擺脫了貼身壓制。',
            en: 'Jumps over them and lands behind, so the throw and every low whiff. The positions reset and you are out of point-blank pressure.',
            ja: '相手を飛び越えて背後に着地し、投げも下段も空振りする。位置がリセットされ、密着の攻めからも抜けられる。',
          },
          followUp: 'neutral',
        },
        onFail: {
          text: {
            'zh-Hant': '起跳被看到就是確定對空 —— 空中無法防禦，而且對空通常能接連段。跳過去的路徑越短，越容易被抓。',
            en: 'A jump they see is a guaranteed anti-air: you cannot block in the air, and anti-airs usually convert. The shorter the arc, the easier it is to catch.',
            ja: 'ジャンプを見られれば対空が確定する。空中はガードできず、対空からコンボに繋がることも多い。飛ぶ距離が短いほど狩られやすい。',
          },
          hpLoss: '30-45%',
          driveLoss: 0,
        },
      ...
      },
      {
        ...
        onSuccess: {
          text: {
            'zh-Hant': '打穿打擊和摔投，把對手打飛，你重新取得場地中央的主導權。',
        ...
        verified: 'estimated',
        notes: {
          'zh-Hant': '不是所有角色都有。低頻使用，價值在於讓對手不敢無腦壓持續 —— 完全不用等於送對手免費的起攻。',
      ...
      },
      {
        ...
        onSuccess: {
          text: {
            'zh-Hant': '純防禦。打擊全部擋下，退康與延遲打擊完全落空 —— 你什麼都沒拿到，但也什麼都沒賠。',
        ...
        onFail: {
          text: {
            'zh-Hant': '對手投你。傷害不高，但你被重新起攻，而且對手學到「這個人不按」—— 之後摔投比例只會更高。',
        ...
        verified: 'estimated',
        notes: {
          'zh-Hant': '最被低估的選項。它是唯一「失敗代價固定且很低」的選擇 —— 對手要靠摔投慢慢磨掉你，比一套連段慢得多。',
...

  {
    ...
    brief: {
      'zh-Hant':
        '你倒在角落，對手站在你身上，身後沒有空間。同樣的選項在這裡代價都更高。',
      en: 'You are down in the corner with them on top of you and nothing behind you. The same options all cost more here.',
      ja: '画面端でダウンし、相手が密着、後ろには何もない。同じ選択肢でも代償はすべて重くなる。',
    },
    summary: {
      'zh-Hant':
        '同一組選項，全部貶一階。後衝刺和後跳沒有空間可退，對手的連段更痛，而且失敗之後你還在原地要再猜一次。\n角落真正貴的不是單次傷害，是它會一直重複。撥擋的評價反而上升 —— 它是唯一能改變位置的低成本選項。',
      en: 'The same option list, every entry a tier worse. Backdash and back jump have no room, their combos hurt more, and losing leaves you in the same spot to guess again.\nThe real cost of the corner is not the single hit but the repetition. Parry grades up in exchange: it is the only cheap option that can change the position.',
      ja: '同じ選択肢が一段ずつ格下げされる。バックダッシュもバックジャンプも下がる空間がなく、相手のコンボ火力は上がり、負ければ同じ位置でもう一度択を迫られる。\n画面端の本当の代償は単発のダメージではなく繰り返されること。代わりにパリィの評価が上がる。位置を変えられる唯一の低コスト択だからである。',
    },
    position: ['cornered'],
    myDrive: ['low', 'mid', 'high'],
    opponentOptions: ['meaty', 'throw', 'shimmy', 'delayed-attack', 'drive-rush-pressure', 'bait-block', 'anti-air'],
    evaluations: [
      {
        ...
        onSuccess: {
          text: {
            'zh-Hant': '同時覆蓋壓持續與摔投。在角落這仍然是最穩的一手，因為它不需要空間。',
        ...
        onFail: {
          text: {
            'zh-Hant': '對手也延遲了打擊，正好打在你按解投的那一刻 —— counter hit，而且角落連段的傷害比場中高一截。',
      ...
      },
      {
        ...
        onSuccess: {
          text: {
            'zh-Hant': '吸收打擊、回一些 Drive，時機準的話完美撥擋直接反打一套並把對手推回去 —— 在角落這是唯一低成本的翻身鍵。',
        ...
        onFail: {
          text: {
            'zh-Hant': '撥擋防不住摔投。傷害不高，但你回到原點 —— 還在角落、再被起攻、Drive 也少了。',
      ...
      },
      {
        ...
        onSuccess: {
          text: {
            'zh-Hant': '摔投被解開，雙方分開一小段。你還在角落，但對手的起攻循環斷了一次。',
        ...
        onFail: {
          text: {
            'zh-Hant': '對手後退看著你按解投 —— 解投有硬直，你吃到完整懲罰連段。這是角落最貴的失敗。',
      ...
      },
      {
        ...
        onSuccess: {
          text: {
            'zh-Hant': '全部擋下。退康和延遲打擊完全落空，你沒有拿到任何東西，但也沒有交出血量。',
      ...
      },
      {
        ...
        onSuccess: {
          text: {
            'zh-Hant': '打斷摔投或還沒發動的動力箭步，換到一點傷害和一次脫離。',
        ...
        onFail: {
          text: {
            'zh-Hant': '被壓持續吃掉 —— counter hit 接角落連段，這是這個情境傷害最高的失敗方式之一。',
      ...
      },
      {
        ...
        onSuccess: {
          text: {
            'zh-Hant': '躲過摔投，而且起始的位移足以讓時間點抓得剛好的壓持續落空。角落退不了多遠，但「退一點」跟「不退」對壓持續來說是兩回事。',
            en: 'Avoids the throw, and the initial movement is enough to make a tightly-timed meaty whiff. There is barely any ground to give, but a little and none are different things to a meaty.',
            ja: '投げを避けられ、初動の移動だけでもタイミングの詰まった重ねを空振りさせられる。画面端では下がれる距離はごく僅かだが、「少し動く」と「動かない」は重ねにとって別物である。',
          },
          followUp: 'neutral',
        },
        onFail: {
          text: {
            'zh-Hant': '後衝刺沒有無敵、收招長，而角落又沒有距離可以拉開 —— 等於在對手面前原地做一個長硬直動作。被抓到通常是 counter hit。',
            en: 'No invincibility, a long recovery, and no room to actually create distance — it amounts to performing a long, committed animation directly in front of them. Getting caught is usually a counter hit.',
            ja: '無敵はなく硬直は長く、しかも画面端では距離を作れない。相手の目の前で長い硬直動作をするのと同じで、狩られればたいていカウンターヒットになる。',
          },
          hpLoss: '35-50%',
          driveLoss: 0,
          positionLoss: {
            'zh-Hant': '仍在角落，且對手學到你會後退',
            en: 'Still cornered, and they have learned you retreat',
            ja: '画面端のまま、しかも下がる癖を読まれる',
          },
        },
        versus: [
          { vs: 'meaty', outcome: 'loss' },
        ...
        verified: 'estimated',
        notes: {
          'zh-Hant': '在角落它的價值只剩「讓壓持續落空」，位移那部分等於沒有。對手一旦用動力箭步追，這個選項就完全失效。',
          en: 'Cornered, its only remaining value is making a meaty whiff; the movement half does nothing. The moment they chase with Drive Rush it stops working entirely.',
          ja: '画面端では「重ねを空振りさせる」価値しか残らず、移動としては機能しない。相手がドライブラッシュで追ってきた時点で完全に無効になる。',
        },
      },
      {
        optionId: 'jump-forward',
        ...
        onSuccess: {
          text: {
            'zh-Hant': '跳過對手落到他背後 —— 攻守的位置直接對調，換成他背對角落。這是角落唯一「位移真的解決問題」的選項，其他移動選擇都只是原地掙扎。',
            en: 'Jumps over them and lands behind: the positions swap outright and now their back is to the wall. It is the only option here where movement actually solves the problem — every other movement choice is just struggling in place.',
            ja: '相手を飛び越えて背後に着地する。攻守の位置が丸ごと入れ替わり、今度は相手が画面端を背負う。移動が本当に問題を解決する唯一の択であり、他の移動択はその場での足掻きにすぎない。',
          },
          followUp: 'neutral',
        },
        onFail: {
          text: {
            'zh-Hant': '對手一直在等這個。角落的跳躍路徑短又好讀，對空是確定命中，空投也是 —— 而且你落回角落，血量差被拉開。',
            en: 'They have been waiting for it. A cornered jump has a short, readable arc, so the anti-air is guaranteed and so is an air throw — and you land back in the corner with the life gap wider.',
            ja: '相手はこれを待っている。画面端のジャンプは軌道が短く読みやすいため対空は確定し、空中投げも確定する。しかも画面端に着地し、体力差だけが開く。',
          },
          hpLoss: '35-50%',
          driveLoss: 0,
          positionLoss: {
            'zh-Hant': '落回角落，且對手確認了你想跳',
            en: 'Lands back in the corner, and they now know you want to jump',
            ja: '画面端に着地し、跳びたがっていることも知られる',
          },
        },
        versus: [
          { vs: 'meaty', outcome: 'loss' },
        ...
        verified: 'estimated',
        notes: {
          'zh-Hant': '回報最高、也最容易被讀。低頻使用，而且最好在對手剛剛用過一次無效的壓持續之後 —— 那是他最不會準備對空的時候。',
          en: 'The highest payoff on the list and the easiest to read. Use it rarely, and preferably right after a setup of theirs has just whiffed — that is when they are least ready to anti-air.',
          ja: 'リターンは最も高く、同時に最も読まれやすい。低頻度で、できれば相手の重ねが空振りした直後に使う。対空の準備が最も薄いのがその瞬間である。',
        },
      },
      {
        optionId: 'jump-back',
        ...
        onSuccess: {
          text: {
            'zh-Hant': '躲過摔投和大部分下段。但角落沒有後退空間，落地後你還在同一個位置 —— 幾乎沒有實質收益。',
      ...
      },
      {
        ...
        onSuccess: {
          text: {
            'zh-Hant': '打穿打擊與摔投，把對手打飛並脫離角落。這是唯一能一次解決「位置」問題的選項。',
...

  {
    ...
    group: 'A',
    name: {
      'zh-Hant': '強制倒地，對手壓好時間點',
      en: 'Hard knockdown, perfectly timed setup',
      ja: 'ハードダウン、完璧に重ねられている',
    },
    brief: {
      'zh-Hant':
        '掃腿之類的招式讓你不能選起身時間。對手可以把攻擊準確壓在你起身那一格，不會失手。',
      en: 'A sweep or similar takes the rise timing away from you. They can put an attack exactly on the frame you stand up, and cannot mistime it.',
      ja: '足払いなどでダウンすると起き上がりのタイミングを選べない。相手は起き上がりの1フレーム目に正確に技を重ねられ、外しようがない。',
    },
    summary: {
      'zh-Hant':
        '強制倒地不能受身，起身時間固定，所以 A1 那一層的猜測不存在了 —— 你沒有早起晚起可以干擾對手。\n少了這一層，每個選擇都變成純猜，而且對手知道確切時間。有趣的是純防禦在這裡反而更好用：對手的優勢是「知道何時」，而防禦不在乎何時。',
      en: 'No quick rise means fixed timing, so the whole A1 layer of mixup is gone — you have no early-or-late to disturb them with.\nWithout it every choice is a bare guess against someone who knows the exact frame. Oddly, that makes pure blocking better here: their edge is knowing when, and blocking does not care when.',
      ja: '受身が取れず起き上がりが固定されるため、A1 の読み合いが丸ごと消える。早起き・遅起きで揺さぶる手段がない。\nその分どの択も正確なタイミングを知る相手への純粋な二択になる。逆にガード択の価値は上がる。相手の優位は「いつか分かること」で、ガードはいつかを問わないからである。',
    },
    position: ['midscreen', 'nearCorner', 'cornered'],
    knockdownType: 'hard',
    opponentOptions: ['meaty', 'throw', 'shimmy', 'delayed-attack', 'bait-block'],
    evaluations: [
      {
        optionId: 'delayed-tech',
        risk: 'medium',
        ...
        onSuccess: {
          text: {
            'zh-Hant': '疊上來的打擊被防住，摔投仍然解得掉。在時間點固定的情況下，這仍是覆蓋面最廣的一手。',
        ...
        onFail: {
          text: {
            'zh-Hant': '對手知道確切時間，所以他的延遲打擊也可以精準地放在你的解投輸入上 —— 這裡的 counter hit 比軟倒地更容易被打出來。',
      ...
      },
      {
        ...
        onFail: {
          text: {
            'zh-Hant': '被投。傷害固定且低，但對手保住主導權，而且會開始把摔投比例調高。',
      ...
      },
      {
        ...
        onSuccess: {
          text: {
            'zh-Hant': '對手的時間點固定，代表你的完美撥擋時機也可以練成固定的 —— 這是少數「對手的優勢反過來變成你的優勢」的地方。',
        ...
        onFail: {
          text: {
            'zh-Hant': '被摔投，Drive 也白花。對手看穿你在等撥擋之後，摔投會變成他的主要選擇。',
      ...
      },
      {
        ...
        onSuccess: {
          text: {
            'zh-Hant': '對手為了完美壓持續通常會提前輸入 —— 這代表他更難臨時改成空防。無敵技在這裡的命中率反而比一般起身高。',
        ...
        onFail: {
          text: {
            'zh-Hant': '對手空防等你 —— punish counter，而且強制倒地通常代表你上一次已經輸掉一個回合，血量差距會被拉開得更難追。',
      ...
      },
      {
        ...
        onSuccess: {
          text: {
            'zh-Hant': '幾乎只有在對手選擇摔投時才會贏。時間點固定代表他的打擊一定比你的輕攻擊先到。',
        ...
        verified: 'estimated',
        notes: {
          'zh-Hant': '軟倒地時它是低頻但有價值的威嚇；強制倒地時它基本上是送分。這是同一選項評價落差最大的例子之一。',
...

  {
    ...
    brief: {
      'zh-Hant':
        '對手花動力槽衝進來，攻擊到得更快也更有利。但他每做一次就燒掉一格。',
      en: 'They spend Drive to dash in, so the attack arrives faster and more plus. Every attempt burns a bar.',
      ja: '相手はドライブを使って踏み込み、攻撃をより速く有利な状態で届けてくる。ただし毎回ゲージを消費している。',
    },
    summary: {
      'zh-Hant':
        '攻擊到得更快，上下二擇也快到很難反應，解投的窗口變窄。\n動力衝擊在這裡被低估：對手花格買到的就是「打擊更快到」，而動力衝擊專門吃打擊。另外記得他一直在燒格 —— 擋兩三次他就會進力盡。',
      en: 'Attacks arrive faster, the high-low mix outruns comfortable reaction time, and your tech window narrows.\nDrive Impact is underrated here: what they bought with the bar is a faster strike, and armour is built to eat strikes. Also, they are burning bars — block two or three and they hit Burnout.',
      ja: '攻撃は速く届き、中下段の二択も反応困難な速度になり、投げ抜けの猶予は狭くなる。\nここではドライブインパクトが過小評価されている。相手がゲージで買ったのは「速く届く打撃」で、アーマーは打撃を食べるためにある。加えて相手はゲージを燃やし続けており、二、三回ガードすればバーンアウトする。',
    },
    position: ['midscreen', 'nearCorner', 'cornered'],
    opponentDrive: ['mid', 'high'],
    opponentOptions: ['drive-rush-pressure', 'throw', 'low-overhead-mix', 'delayed-attack', 'bait-block', 'drive-impact'],
    evaluations: [
      {
        optionId: 'do-nothing',
        risk: 'low',
        ...
        onSuccess: {
          text: {
            'zh-Hant': '擋下來，讓他繼續燒 Drive。你沒有拿到血，但拿到了資源差 —— 這是對抗動力箭步壓制最穩的長線做法。',
        ...
        onFail: {
          text: {
            'zh-Hant': '被投，或是被下段/中段猜中。動力箭步讓二擇快到很難反應，純防禦在這裡不是零風險。',
      ...
      },
      {
        ...
        onSuccess: {
          text: {
            'zh-Hant': '霸體吃下動力箭步接的打擊並反擊 —— 對手被撞飛，如果靠牆就是撞牆重擊接完整連段，一次把資源差和血量差全部逆轉。',
        ...
        onFail: {
          text: {
            'zh-Hant': '對手用自己的動力衝擊撞回來，或是直接投你 —— DI 的霸體防不住摔投。被 DI 反撞在角落是最糟的結果。',
      ...
      },
      {
        ...
        onSuccess: {
          text: {
            'zh-Hant': '仍然同時覆蓋打擊與摔投，只是窗口比一般起身窄。',
        ...
        onFail: {
          text: {
            'zh-Hant': '對手用動力箭步的有利去做延遲打擊，counter hit 之後還能再接一次動力箭步延伸 —— 傷害比一般 counter hit 更高。',
      ...
      },
      {
        ...
        onSuccess: {
          text: {
            'zh-Hant': '擋下動力箭步的打擊並回一點 Drive。完美撥擋的話對手等於白花了三格 —— 資源差瞬間拉開。',
        ...
        onFail: {
          text: {
            'zh-Hant': '被摔投，而且你也在花 Drive —— 兩邊一起燒的時候，先見底的那個會很慘。',
      ...
      },
      {
        ...
        onFail: {
          text: {
            'zh-Hant': '動力箭步接的打擊比你的輕攻擊快得多 —— counter hit 接完整連段，而且對手還有 Drive 可以延伸。',
...

  {
    ...
    brief: {
      'zh-Hant':
        '對手已經在騙你的解投了。這時候繼續按解投等於送分。',
      en: 'They are already baiting your tech. Keeping on teching is just donating.',
      ja: '相手は既に投げ抜けを誘っている。ここで投げ抜けを押し続けるのは献上に等しい。',
    },
    summary: {
      'zh-Hant':
        '這不是位置問題，是對手露出習慣了：他後退騙你解投再懲罰，或把打擊延到你的解投輸入上。\n認出來之後整組選項要重排 —— 解投從主力變最差，純防禦變最好。退康的弱點是它對不出手的人完全沒有威脅，所以你一停手，他就得改回摔投，那時再把解投加回來。',
      en: 'This is not a position problem, it is a tell: they walk back to bait the tech and punish it, or delay the strike onto your tech input.\nOnce you see it, the whole list re-ranks — teching drops from staple to worst, blocking becomes best. Shimmy threatens nothing against someone who does not press, so the moment you stop they have to go back to throwing, and that is when the tech comes back.',
      ja: 'これは位置の問題ではなく相手の癖である。下がって投げ抜けを誘い狩る、あるいは打撃を投げ抜けの入力に合わせて遅らせてくる。\n見抜いた時点で択の順位は入れ替わる。投げ抜けは主軸から最悪へ、ガードは最善へ。シミーは押してこない相手に何の脅威も与えられないため、こちらが止めれば相手は投げに戻らざるを得ず、その時に投げ抜けを戻す。',
    },
    position: ['midscreen', 'nearCorner', 'cornered'],
    opponentOptions: ['shimmy', 'delayed-attack', 'throw', 'meaty'],
    evaluations: [
      {
        optionId: 'do-nothing',
        risk: 'safe',
        ...
        onSuccess: {
          text: {
            'zh-Hant': '退康完全落空 —— 他後退的那段是無防備的，你甚至可以直接反打。延遲打擊也只是被防住。這是這個情境的正解。',
        ...
        onFail: {
          text: {
            'zh-Hant': '對手放棄退康改成直接摔投。傷害很低，而且這正是你要的訊號 —— 他被迫改回來了。',
      ...
      },
      {
        ...
        onSuccess: {
          text: {
            'zh-Hant': '延遲打擊正好撞進撥擋。對手把時間點拉長的行為讓完美撥擋反而更好抓 —— 抓到就是一整套反打。',
        ...
        onFail: {
          text: {
            'zh-Hant': '被摔投。花了 Drive、拿了小傷害，但沒有崩盤 —— 在這個情境撥擋的下檔風險很低。',
        ...
        verified: 'estimated',
        notes: {
          'zh-Hant': '對手越是延遲，撥擋的價值越高 —— 他為了打你的解投而拉長的時間，正好是你按撥擋的時間。',
      ...
      },
      {
        ...
        onSuccess: {
          text: {
            'zh-Hant': '對手後退退康的時候是無防備的 —— 如果你的輕攻擊搆得到，這是少數能直接懲罰退康的方式。',
        ...
        onFail: {
          text: {
            'zh-Hant': '對手選的是延遲打擊而不是退康 —— 那一下正好打在你的輕攻擊起動上，counter hit。',
        ...
        verified: 'estimated',
        notes: {
          'zh-Hant': '這是唯一一個「速點」評價上升的情境 —— 因為退康本身就是把自己暴露出來換取懲罰機會。',
      ...
      },
      {
        ...
        onFail: {
          text: {
            'zh-Hant': '這正是對手在等的東西。退康抓到解投就是完整懲罰連段，而且他會一直重複到你停下來為止。',
