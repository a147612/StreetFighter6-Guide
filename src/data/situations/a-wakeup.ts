...

  {
    ...
    evaluations: [
      ...
      },
      {
        ...
        onSuccess: {
          text: {
            'zh-Hant': '跳過對手換到他背後，投擲與下段全部落空。場地位置重置，你也擺脫了貼身壓制。',
...

  {
    ...
    evaluations: [
      ...
      },
      {
        ...
        onSuccess: {
          text: {
            'zh-Hant': '躲過投擲，而且起始的位移足以讓時間點抓得剛好的疊招落空。角落退不了多遠，但「退一點」跟「不退」對疊招來說是兩回事。',
        ...
        verified: 'estimated',
        notes: {
          'zh-Hant': '在角落它的價值只剩「讓疊招落空」，位移那部分等於沒有。對手一旦用 Drive Rush 追，這個選項就完全失效。',
      ...
      },
      {
        ...
        verified: 'estimated',
        notes: {
          'zh-Hant': '回報最高、也最容易被讀。低頻使用，而且最好在對手剛剛用過一次無效的疊招之後 —— 那是他最不會準備對空的時候。',
